...
db_top_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data")
...
training_args = TrainingArguments(
    ...
    # Save model checkpoints every N steps (must match eval_steps for load_best_model_at_end).
    save_steps=100,
...
trainer = Trainer(
    ...
    processing_class=processor,   # transformers 5.x: use processing_class
